...
public final class NNCalcView1 extends JFrame implements NNCalcView {
    ...
    public NNCalcView1() {
         ...
         */
        JPanel mainButtonPane = new JPanel(new GridLayout(
                MAIN_BUTTON_PANEL_GRID_ROWS, MAIN_BUTTON_PANEL_GRID_COLUMNS));
        /*
         * Add the buttons to the main button panel, from left to right and top
         * to bottom
         */
        mainButtonPane.add(this.bDigits[7]);
        mainButtonPane.add(this.bDigits[8]);
        mainButtonPane.add(this.bDigits[9]);
        mainButtonPane.add(this.bAdd);
        mainButtonPane.add(this.bDigits[4]);
        mainButtonPane.add(this.bDigits[5]);
        mainButtonPane.add(this.bDigits[6]);
        mainButtonPane.add(this.bSubtract);
        mainButtonPane.add(this.bDigits[1]);
        mainButtonPane.add(this.bDigits[2]);
        mainButtonPane.add(this.bDigits[3]);
        mainButtonPane.add(this.bMultiply);
        mainButtonPane.add(this.bDigits[0]);
        mainButtonPane.add(this.bPower);
        mainButtonPane.add(this.bRoot);
        mainButtonPane.add(this.bDivide);

        /*
         * Create side button panel
         */
        JPanel sideButtonPane = new JPanel(new GridLayout(
         ...
         * to bottom
         */
        sideButtonPane.add(this.bClear);
        sideButtonPane.add(this.bSwap);
        sideButtonPane.add(this.bEnter);
        /*
         ...
         */
        combinedButtonPanel.add(mainButtonPane);
        combinedButtonPanel.add(sideButtonPane);
        /*
         ...
         * and top to bottom
         */
        this.add(tTopTextScrollPane);
        this.add(tBottomTextScrollPane);
